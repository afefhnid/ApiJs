...
router.delete(
  "/companys/:idCompany/ticket/:idTicket",
  CompanyController.deleteTicket
);
router.put(
  "/companys/:idCompany/ticket/:idTicket",
  CompanyController.updateTicket
);
router.get("/companys/ticket/:id", CompanyController.getTicketById);
router.get("/companys/ticket/user/:idUser", CompanyController.getTicketByUser);

//type
router.get("/types/:id", TypeConttoller.getType);
router.get("/types", TypeConttoller.list);
